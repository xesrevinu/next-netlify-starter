...
function BuiltInCSSSupport() {
  return (
    <div>
      ...
      <h2>CSS Modules</h2>
      <p>
        CSS Modules are an optional feature and are only enabled for files with
      ...
      <div data-testid="css-in-js">
        <h2>CSS-in-JS</h2>
        <p>
          NextJS bundles styled-jsx to provide support for isolated scoped CSS.
          The aim is to support &quot;shadow CSS&quot; similar to Web
          Components, which unfortunately do not support server-rendering and
          are JS-only.
        </p>
        <style jsx>{`
          p {
        ...
        `}</style>
        <p>
          This section should be differently styled compared to the others (i.e.
          orange background)
        </p>
        <style global jsx>{`
          body {
